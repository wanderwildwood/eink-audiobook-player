package audiobook.features.bookmark
...
import audiobook.core.ui.NoAnimationDropdownMenu
import audiobook.core.ui.icons.Icons
import audiobook.features.bookmark.dialogs.AddBookmarkDialog
import audiobook.features.bookmark.dialogs.EditBookmarkDialog
  ...
  Scaffold(
    ...
    floatingActionButton = {
      FloatingActionButton(
        onClick = onAdd,
        content = {
          Icon(imageVector = Icons.Add, contentDescription = stringResource(id = StringsR.string.common_action_add))
        },
      )
    },
  ) { paddingValues ->
