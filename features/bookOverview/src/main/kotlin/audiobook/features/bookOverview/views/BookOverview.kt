...
import audiobook.features.bookOverview.bottomSheet.BottomSheetContent
import audiobook.features.bookOverview.bottomSheet.BottomSheetItem
import audiobook.features.bookOverview.deleteBook.DeleteBookDialog
import audiobook.features.bookOverview.di.BookOverviewGraph
import audiobook.features.bookOverview.editGenre.EditBookGenreDialog
import audiobook.features.bookOverview.editTitle.EditBookTitleDialog
...
import audiobook.features.bookOverview.views.topbar.BookOverviewTopBar
...
internal fun BookOverview(
  ...
  Scaffold(
    ...
    PullToRefreshBox(
      ...
      onRefresh = onRefresh,
      // No indicator: its spinner is the one thing left in the app that animates forever,
      // which an e-ink panel can't draw. The "Scanning library…" label in the top bar is
  ...
  when (dialog) {
    BookOverviewViewState.Dialog.FolderPickerMovedToSettings -> {
      NoAnimationAlertDialog(
        ...
        icon = {
          Row {
            Icon(imageVector = Icons.ArrowForward, contentDescription = null)
            Icon(imageVector = Icons.Settings, contentDescription = null)
            Icon(imageVector = Icons.ArrowBack, contentDescription = null)
          }
        },
        title = {
