...
import audiobook.core.data.store.ThemeColorSchemeStore
import audiobook.core.data.store.ThemeModeStore
import audiobook.core.data.store.intPrefsDataMigration
...
class MigrationTests {
  ...
  private val factory: StoreFactory =
    StoreFactory(Json { ignoreUnknownKeys = true }, ApplicationProvider.getApplicationContext())
  ...
  fun `defaults are used when SharedPreferences empty`() = runTest {
    ...
    assertEquals(expected = ThemeColorScheme.Blue, actual = testGraph.themeColorSchemeStore.data.first())
  }
